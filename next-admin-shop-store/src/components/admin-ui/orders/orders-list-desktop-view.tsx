            ...
            orders.map((order) => (
              <TableRow key={order.id} className="border-b border-gray-200 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800">
                          ...
                          <TooltipContent>
                            <div className="flex flex-col gap-1">
                              ...
                              <p className="text-sm text-white">
                                {item.quantity} × {formatCurrency(item.price)} - {formatCurrency(item.discount)} = {formatCurrency(item.total)}
                              </p>
                            </div>
                          </TooltipContent>
                        </Tooltip>
                ...
                <TableCell className="px-2 flex items-center justify-center gap-2 text-sm font-normal text-muted-foreground md:px-6">
                  <Button variant="outline" size="icon" className="cursor-pointer rounded-full" onClick={() => handleEdit(order)}>
                    <Pencil className="h-5 w-5 text-muted-foreground" />
                  </Button>
                  <Button variant="outline" size="icon" className="cursor-pointer rounded-full" onClick={() => handleDelete(order)}>
