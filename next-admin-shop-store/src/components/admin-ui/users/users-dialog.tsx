      ...
      <DialogContent className="max-w-md rounded-[18px!important]">
        ...
        <form className="grid gap-4 py-4" onSubmit={handleSubmit} id="users-dialog-form">
          <div className="space-y-1">
            ...
            <Input value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder={t('components.admin-ui.users.users-dialog.name-placeholder')} className="w-full shadow-none focus-visible:ring-1" id="name" />
          </div>
          <div className="space-y-1">
            <Label htmlFor="email" className="text-right text-xs">
              {t('components.admin-ui.users.users-dialog.email-placeholder')}
            </Label>
            <Input value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} placeholder={t('components.admin-ui.users.users-dialog.email-placeholder')} className="w-full shadow-none focus-visible:ring-1" />
          </div>
          <div className="space-y-1">
            <Label htmlFor="phone" className="text-right text-xs">
              {t('components.admin-ui.users.users-dialog.phone-placeholder')}
            </Label>
            <Input value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} placeholder={t('components.admin-ui.users.users-dialog.phone-placeholder')} className="w-full shadow-none focus-visible:ring-1" />
          </div>
          <div className="space-y-1">
            <Label htmlFor="password" className="text-right text-xs">
              {t('components.admin-ui.users.users-dialog.password-placeholder')}
            </Label>
            <Input value={formData.password} onChange={(e) => setFormData({ ...formData, password: e.target.value })} placeholder={t('components.admin-ui.users.users-dialog.password-placeholder')} className="w-full shadow-none focus-visible:ring-1" />
          </div>
          <div className="space-y-1">
